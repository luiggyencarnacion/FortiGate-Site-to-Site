...
- `files/FTG-ESTE_7-0_0237_Site-to-Site.conf` (exportación completa de FortiOS — FTG-ESTE)
- `files/FTG-OESTE_7-0_0237_Site-to-Site.conf` (exportación completa de FortiOS — FTG-OESTE)
